  ...
  return (
    <Layout>
      ...
      <VStack gap={10} className={s.questionContainer}>
        ...
        <VStack as={'article'} gap={15}>
            <HStack align="center" gap={10}>
                <img src="https://www.chosun.com/resizer/v2/ILPMAH7RI3HDRTYFHUZPDX7AYM.jpg?auth=0bd04425fba26b475c67128aa446de16be468a0bc20a4ed952bb57810180ec4c&width=616" alt="profile" />
                <span>김민수</span>
            </HStack>
          <span>
      ...
      <div className={s.buttonContainer}>
        <Button style={{ width: "100%" }} onClick={() => handleComplete()}>완료</Button>
      </div>
    </Layout>
  );
}
